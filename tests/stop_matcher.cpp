...
//
// Unit tests for include/geniex-proc/stop_matcher.h: byte-level stop-sequence
// matching used by LLM pipelines' generateTokens(). Pure string logic; no QNN
// runtime, no tokenizer.
